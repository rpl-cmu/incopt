...
def generate3Ddataset(dataset_str):
    ...
    if dataset_str is "SmallDemo":
        ...
        # dataset.map, dataset.corner_idx = add_obstacle(
        #     [120, 120, 150], [60, 60, 60], dataset.map, dataset.corner_idx
        # )
    ...
    # dataset 2: desk dataset for WAM WAMDeskDataset
        ...
        # shelf
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 190, 145], [60, 25, 190], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 90, 145], [60, 25, 190], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [200, 190, 145], [40, 25, 190], dataset.map, dataset.corner_idx
        )
        # [dataset.map, dataset.corner_idx] = add_obstacle(
        #     [130, 40, 95], [60, 5, 190], dataset.map, dataset.corner_idx
        # )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 140, 240], [60, 100, 25], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
        ...
        # table
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [170, 220, 110], [140, 60, 5], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [105, 195, 70], [10, 10, 60], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [235, 195, 70], [10, 10, 80], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [105, 245, 70], [10, 10, 80], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [235, 245, 70], [10, 10, 80], dataset.map, dataset.corner_idx
        )
        ...
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 20, 145], [60, 25, 190], dataset.map, dataset.corner_idx
        )
        #[dataset.map, dataset.corner_idx] = add_obstacle(
        #    [250, 190, 145], [40, 25, 190], dataset.map, dataset.corner_idx
        # )
        #[dataset.map, dataset.corner_idx] = add_obstacle(
        #     [130, 40, 95], [60, 5, 190], dataset.map, dataset.corner_idx
        # )
        ...
        # )
        [dataset.map, dataset.corner_idx] = add_obstacle(
             [250, 100, 200], [60, 200, 5], dataset.map, dataset.corner_idx
        )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 100, 140], [60, 200, 5], dataset.map, dataset.corner_idx
         )
        [dataset.map, dataset.corner_idx] = add_obstacle(
            [250, 100, 70], [60, 200, 5], dataset.map, dataset.corner_idx
        )
