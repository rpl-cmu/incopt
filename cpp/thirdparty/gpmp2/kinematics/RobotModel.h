...
public:
  std::vector<BodySphere> body_spheres_;
  void push_back(BodySphere body_sphere) {
    body_spheres_.push_back(body_sphere);
  }
  BodySphereVector() {}
  ~BodySphereVector() {}
};
...
public:
  ...
  /// vector of body sphere, typedef here because no wrap in matlab
...
#include <cpp/thirdparty/gpmp2/kinematics/RobotModel-inl.h>
