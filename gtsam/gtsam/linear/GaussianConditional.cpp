...
namespace gtsam {
  ...
  /* ************************************************************************* */
  std::pair<VectorValues, Vector> GaussianConditional::solveConstrained(
    const VectorValues& parents, const Vector& y) const {
    //std::cout << "iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii" << std::endl;
    ...
    return pair<VectorValues, Vector>(result, soln);
  }
