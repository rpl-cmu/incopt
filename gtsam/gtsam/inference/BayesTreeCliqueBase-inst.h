...
namespace gtsam {
  ...
  /* ************************************************************************* */
  template<class DERIVED, class FACTORGRAPH>
  void BayesTreeCliqueBase<DERIVED, FACTORGRAPH>::cacheConstraintFactors(
    FastVector<boost::shared_ptr<FactorType>> constraintFactors, FastVector<int> factorIndices)
  {
    // Implemented for ISAM2Cliques only
    return;
  }
