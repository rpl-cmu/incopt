...
class FactorGraph {
 ...
 public:
  ...
  /** Map from factor index to constraintFactorType_ **/
  FastMap<int, int> factorIndexToconstraintFactorType_;
  
  /** Number of hard equality constraints **/
  size_t Neq_ = 0;

  /** Number of hard inequality constraints **/
  size_t Nieq_ = 0;
