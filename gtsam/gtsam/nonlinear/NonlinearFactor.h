...
public:
  ...
  virtual Vector constraintError(const Value& val) const { return Vector(); }
  virtual Matrix constraintJacobian(const Value& val) const { return Matrix(); }
  ...
  /** return error for constrained optimization */
  virtual Vector errorBConstrained(const Values& x) const { return Vector(); }

  virtual double errorConstrained(const Values& x) const { return 0.0; }

  virtual double errorUnwhitened(const Values& x) const { return 0.0; }

  virtual void setSatisfiedConstraint(Vector* b, std::vector<Matrix>* A) const {};

  virtual void setSatisfiedConstraintb(Vector* b) const {};
  
  virtual void rhoScaling(Vector* b, std::vector<Matrix>* A) const {};
...
public:
  ...
  Vector errorBConstrained(const Values& x) const override;

  double errorConstrained(const Values& x) const override;

  double errorUnwhitened(const Values& x) const override;
  ...
  void setSatisfiedConstraint(Vector* b, std::vector<Matrix>* A) const override;

  void setSatisfiedConstraintb(Vector* b) const override;

  void rhoScaling(Vector* b, std::vector<Matrix>* A) const override;
