...
struct GTSAM_EXPORT ISAM2Params {
  ...
  bool forceConstrainedDeltaUpdate; ///< When constrains are enabled. Update delta regradless
                                    ///< of the output of relinarizationNeeded
  ...
  ISAM2Params(OptimizationParams _optimizationParams = ISAM2GaussNewtonParams(),
              ...
              bool _forceConstrainedDeltaUpdate = false)
      : optimizationParams(_optimizationParams),
        ...
        forceConstrainedDeltaUpdate(_forceConstrainedDeltaUpdate) {}
  ...
  void print(const std::string& str = "") const {
    ...
    cout << "findUnusedFactorSlots:             " << findUnusedFactorSlots
         << "\n";
    cout << "forceConstrainedDeltaUpdate:             " << forceConstrainedDeltaUpdate
         << "\n";
    cout.flush();
  }
  ...
  bool isForceConstrainedDeltaUpdate() const { return forceConstrainedDeltaUpdate; }
  ...
  void setForceConstrainedDeltaUpdate(bool forceConstrainedDeltaUpdate) {
    this->forceConstrainedDeltaUpdate = forceConstrainedDeltaUpdate;
  }
